...
public class PageView<T> implements Serializable {
	...
	public PageView(PageParam pageParam, List<T> list, long total) {
		this(pageParam, list, total, 8);
	}

	public PageView(PageParam pageParam, List<T> list, long total, int navigatePages) {
		if (list instanceof Collection) {
			...
			this.size = list.size();
			this.total = total;
			this.startRow = pageNum * (pageSize - 1);
