package com.kaloo.common.utils.number;
...
public abstract class AmountUtils {
	...
	public static void main(String[] args) {
		Double a = 101.005D;
		Double b = 0.0D;
		Double s = AmountUtils.sub(a, b);
		System.out.println(AmountUtils.roundDown(s));
		System.out.println(AmountUtils.div(101.1D, 1D, 2));
	}
}
